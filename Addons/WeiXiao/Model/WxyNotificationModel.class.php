...
class WxyNotificationModel extends Model
{
    protected $tableName = 'wxy_notification';

    public function addMessage($url = '', $info, $token)
    {
        $data['message'] = json_encode($info, JSON_UNESCAPED_UNICODE);
    ...
    public function send_school_notification_to_user($openId, $url, $info, $token) {
        if ($info == NULL) return false;
        $map['token'] = $token;
        $map['msg_type'] = 'school notify';
